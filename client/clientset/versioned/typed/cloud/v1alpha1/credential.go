...
func newCredentials(c *CloudV1alpha1Client) *credentials {
	return &credentials{
		client: c.RESTClient(),
	}
}
...
func (c *credentials) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Credential, err error) {
...
func (c *credentials) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.CredentialList, err error) {
...
func (c *credentials) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *credentials) Create(ctx context.Context, credential *v1alpha1.Credential, opts v1.CreateOptions) (result *v1alpha1.Credential, err error) {
	result = &v1alpha1.Credential{}
	err = c.client.Post().
		Resource("credentials").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *credentials) Update(ctx context.Context, credential *v1alpha1.Credential, opts v1.UpdateOptions) (result *v1alpha1.Credential, err error) {
	result = &v1alpha1.Credential{}
	err = c.client.Put().
		Resource("credentials").
...
func (c *credentials) UpdateStatus(ctx context.Context, credential *v1alpha1.Credential, opts v1.UpdateOptions) (result *v1alpha1.Credential, err error) {
	result = &v1alpha1.Credential{}
	err = c.client.Put().
		Resource("credentials").
		Name(credential.Name).
...
func (c *credentials) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *credentials) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *credentials) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Credential, err error) {
	result = &v1alpha1.Credential{}
