...
// CloudV1alpha1Client is used to interact with features provided by the cloud.bytebuilders.dev group.
type CloudV1alpha1Client struct {
	restClient rest.Interface
}

func (c *CloudV1alpha1Client) CloudProviders() CloudProviderInterface {
	return newCloudProviders(c)
}

func (c *CloudV1alpha1Client) Credentials() CredentialInterface {
	return newCredentials(c)
}

func (c *CloudV1alpha1Client) MachineTypes() MachineTypeInterface {
