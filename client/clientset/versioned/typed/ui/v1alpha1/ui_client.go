...
type UiV1alpha1Interface interface {
	...
	OptionsEditorsGetter
}

// UiV1alpha1Client is used to interact with features provided by the ui.bytebuilders.dev group.
type UiV1alpha1Client struct {
	restClient rest.Interface
}

func (c *UiV1alpha1Client) OptionsEditors() OptionsEditorInterface {
	return newOptionsEditors(c)
}
