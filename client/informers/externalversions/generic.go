...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case clusterv1alpha1.SchemeGroupVersion.WithResource("clusteruserauths"):
		...
		// Group=identity.bytebuilders.dev, Version=v1alpha1
	case identityv1alpha1.SchemeGroupVersion.WithResource("orgusers"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Identity().V1alpha1().OrgUsers().Informer()}, nil
	case identityv1alpha1.SchemeGroupVersion.WithResource("teams"):
