...
type CloudProviderInformer interface {
	...
	Lister() v1alpha1.CloudProviderLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CloudV1alpha1().CloudProviders().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CloudV1alpha1().CloudProviders().Watch(context.TODO(), options)
			},
		},
		&cloudv1alpha1.CloudProvider{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *cloudProviderInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&cloudv1alpha1.CloudProvider{}, f.defaultInformer)
}

func (f *cloudProviderInformer) Lister() v1alpha1.CloudProviderLister {
	return v1alpha1.NewCloudProviderLister(f.Informer().GetIndexer())
}
