...
func schema_resource_model_apis_cluster_v1alpha1_Cluster(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_resource_model_apis_cluster_v1alpha1_ClusterCredentialSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"go.bytebuilders.dev/resource-model/apis/cluster/v1alpha1.AWSCredential", "go.bytebuilders.dev/resource-model/apis/cluster/v1alpha1.AzureCredential", "go.bytebuilders.dev/resource-model/apis/cluster/v1alpha1.DigitalOceanCredential", "go.bytebuilders.dev/resource-model/apis/cluster/v1alpha1.GCECredential", "go.bytebuilders.dev/resource-model/apis/cluster/v1alpha1.LinodeCredential", "go.bytebuilders.dev/resource-model/apis/cluster/v1alpha1.PacketCredential", "go.bytebuilders.dev/resource-model/apis/cluster/v1alpha1.ScalewayCredential", "go.bytebuilders.dev/resource-model/apis/cluster/v1alpha1.VultrCredential"},
	}
}
...
func schema_resource_model_apis_cluster_v1alpha1_ClusterList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_resource_model_apis_cluster_v1alpha1_ClusterSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_resource_model_apis_cluster_v1alpha1_ClusterStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					"observedGeneration": {
						SchemaProps: spec.SchemaProps{
							Description: "ObservedGeneration is the most recent generation observed for this Cluster. It corresponds to the Cluster's generation, which is updated on mutation by the API Server.",
							Type:        []string{"integer"},
							Format:      "int64",
						},
					},
		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"accessToken": {
						SchemaProps: spec.SchemaProps{
							Description: "Parameters for GKE Provider",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					...
					"region": {
						SchemaProps: spec.SchemaProps{
							Description: "Parameters for AWS Provider",
							Type:        []string{"string"},
							Format:      "",
						},
					},
				...
				Required: []string{"clusterUID", "userID", "importedAt"},
			},
		},
		Dependencies: []string{
			"go.bytebuilders.dev/resource-model/apis/cluster/v1alpha1.AuthProviderConfig"},
...
func schema_resource_model_apis_cluster_v1alpha1_GCECredential(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
