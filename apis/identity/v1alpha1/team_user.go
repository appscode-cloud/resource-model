...
type TeamUserSpec struct {
	...
	TeamID  int64  `json:"teamID" protobuf:"varint,5,opt,name=teamID"`
	// +optional
	TeamName int64 `json:"teamName" protobuf:"varint,6,opt,name=teamName"`
	IsPublic bool  `json:"isPublic" protobuf:"varint,7,opt,name=isPublic"`
}
