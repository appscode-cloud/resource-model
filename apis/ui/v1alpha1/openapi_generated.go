...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"go.bytebuilders.dev/resource-model/apis/ui/v1alpha1.ChartRepoRef":        schema_resource_model_apis_ui_v1alpha1_ChartRepoRef(ref),
		"go.bytebuilders.dev/resource-model/apis/ui/v1alpha1.OptionsEditor":       schema_resource_model_apis_ui_v1alpha1_OptionsEditor(ref),
		"go.bytebuilders.dev/resource-model/apis/ui/v1alpha1.OptionsEditorList":   schema_resource_model_apis_ui_v1alpha1_OptionsEditorList(ref),
		"go.bytebuilders.dev/resource-model/apis/ui/v1alpha1.OptionsEditorSpec":   schema_resource_model_apis_ui_v1alpha1_OptionsEditorSpec(ref),
		"go.bytebuilders.dev/resource-model/apis/ui/v1alpha1.OptionsEditorStatus": schema_resource_model_apis_ui_v1alpha1_OptionsEditorStatus(ref),
		"go.bytebuilders.dev/resource-model/apis/ui/v1alpha1.ResourceID":          schema_resource_model_apis_ui_v1alpha1_ResourceID(ref),
...
func schema_resource_model_apis_ui_v1alpha1_ChartRepoRef(ref common.ReferenceCallback) common.OpenAPIDefinition {
...
func schema_resource_model_apis_ui_v1alpha1_OptionsEditor(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("go.bytebuilders.dev/resource-model/apis/ui/v1alpha1.OptionsEditorSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("go.bytebuilders.dev/resource-model/apis/ui/v1alpha1.OptionsEditorStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"go.bytebuilders.dev/resource-model/apis/ui/v1alpha1.OptionsEditorSpec", "go.bytebuilders.dev/resource-model/apis/ui/v1alpha1.OptionsEditorStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_resource_model_apis_ui_v1alpha1_OptionsEditorList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("go.bytebuilders.dev/resource-model/apis/ui/v1alpha1.OptionsEditor"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"go.bytebuilders.dev/resource-model/apis/ui/v1alpha1.OptionsEditor", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}

func schema_resource_model_apis_ui_v1alpha1_OptionsEditorSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					"resource": {
						SchemaProps: spec.SchemaProps{
							Description: "Resource identifies the resource to which this editor applies",
							Ref:         ref("go.bytebuilders.dev/resource-model/apis/ui/v1alpha1.ResourceID"),
						},
					},
					"chartRef": {
						SchemaProps: spec.SchemaProps{
							Description: "ChartRef references a Helm chart with the ui.json",
							Ref:         ref("go.bytebuilders.dev/resource-model/apis/ui/v1alpha1.ChartRepoRef"),
						},
					},
					"category": {
						SchemaProps: spec.SchemaProps{
							Description: "Category defines the category of the application that this editor is for (eg, database)",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"provider": {
						SchemaProps: spec.SchemaProps{
							Description: "Provider defines the name of the provider for this application (eg, kubedb.com)",
							Type:        []string{"string"},
							Format:      "",
						},
					},
				},
				Required: []string{"resource", "chartRef", "category", "provider"},
			},
		},
		Dependencies: []string{
			"go.bytebuilders.dev/resource-model/apis/ui/v1alpha1.ChartRepoRef", "go.bytebuilders.dev/resource-model/apis/ui/v1alpha1.ResourceID"},
	}
}

func schema_resource_model_apis_ui_v1alpha1_OptionsEditorStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_resource_model_apis_ui_v1alpha1_ResourceID(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
